...
public class Lab5 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("input-email")).sendKeys("bansal@gmail.com");
 
		driver.findElement(By.id("input-telephone")).sendKeys("9876543210");
 
		driver.findElement(By.xpath("//input[@type='submit' and @value='Continue']")).click();
		
		driver.findElement(By.id("input-password")).sendKeys("Labuser@1235");
		
		driver.findElement(By.id("input-confirm")).sendKeys("Labuser@1235");
